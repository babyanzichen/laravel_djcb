...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/')}}auth/static/js/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ asset('/')}}auth/static/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{ asset('/')}}auth/static/css/index.css">
    <script src="{{ asset('/')}}auth/static/js/jquery/jQuery-2.2.0.min.js"></script>
    <script src="{{ asset('/')}}auth/static/js/charts/Chart.js"></script>
    <script>
        $(function () {
            Canvas1();
            Canvas2();
        ...
        function Canvas1() {
            ...
            var doughnutData = [
                @foreach ($userCounts as $userCount)
                    ...
                    color:"{{$userCount->color}}",
                    highlight: "{{$userCount->hightlight}}",
    ...
    <div id="areascontent">
                ...
                <div style="height: 100%; border: 1px solid #e6e6e6; overflow: hidden;">
                    ...
                    <a href="/dashboard/user">
                        <div class="dashboard-stats-item" style="background-color: #4f5c65; margin-bottom: 0px;">
                            <h2 class="m-top-none">{{$newUser}}<span>位</span></h2>
                            <h5>今日新增会员</h5>
                            <div class="stat-icon">
                    ...
                    <div class="dashboard-stats">
                     <a href="/dashboard/vote">
                        <div class="dashboard-stats-item" style="background-color: #14aae4; margin-bottom: 0px;">
                            <h2 class="m-top-none">{{$newSign}}<span>条</span></h2>
                            <h5>今日新增报名</h5>
                            <div class="stat-icon">
            ...
            <div style="float: right; width: 30%;">
                <div style="height: 221px; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        <div class="panel-heading"><i class="fa fa-area-chart fa-lg" style="padding-right: 5px;"></i>首页日流量</div>
        ...
        <div class="rows" style="margin-bottom: 0.8%; overflow: hidden;">
            ...
            <div style="float: right; width: 30%;">
                <div style="height: 290px; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        <div class="panel-heading"><i class="fa fa-pie-chart fa-lg" style="padding-right: 5px;"></i>用户性别构成</div>
                        <div class="panel-body">
                            <canvas id="Canvas1" style="height: 180px; width: 100%; margin-top: 10px;"></canvas>
                            <div style="text-align: center; padding-top: 15px;">
                                <span><i class="fa fa-square" style="color: #F7464A; font-size: 20px; padding-right: 5px; vertical-align: middle; margin-top: -3px;"></i>女</span>
                                <span style="margin-left: 10px;"><i class="fa fa-square" style="color:#2196f3; font-size: 20px; padding-right: 5px; vertical-align: middle; margin-top: -3px;"></i>男</span>
                                <span style="margin-left: 10px;"><i class="fa fa-square" style="color: #FDB45C; font-size: 20px; padding-right: 5px; vertical-align: middle; margin-top: -3px;"></i>其它</span>
                                <span style="margin-left: 10px;"><i class="fa fa-square" style="color: #949FB1; font-size: 20px; padding-right: 5px; vertical-align: middle; margin-top: -3px;"></i>未知</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                ...
                                <li><a  target="_blank">{{ $article->title }}</a><span class="time">{{$article->addtime}}</span></li>
                                @endforeach
            ...
            <div style="float: left; width: 34.6%; margin-right: 0.8%;">
                <div style="height: 240px; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                <li><a  target="_blank">【通知】新版员工守则，即日执行</a><span class="time">2016-07-21</span></li>
                                <li><a  target="_blank">【公告】OA办公使用指南</a><span class="time">2016-07-21</span></li>
                                <li><a  target="_blank">【公告】劳动节集体出游指南</a><span class="time">2016-07-21</span></li>
                                <li><a  target="_blank">【通知】2016年G20财长和央行行</a><span class="time">2016-07-21</span></li>
                                <li><a  target="_blank">【通知】2016年G20财长和央行行</a><span class="time">2016-07-21</span></li>
                                <li><a  target="_blank">【通知】品牌价值的最佳选择</a><span class="time">2016-07-21</span></li>
                                <li><a  target="_blank">【公告】采购商城全新升级自营业正品</a><span class="time">2016-07-21</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div style="float: right; width: 30%;">
                <div style="height: 240px; border: 1px solid #e6e6e6; background-color: #fff;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                <li><a  target="_blank">南京森鹿皮件服饰有限公司</a><span class="time">2016-07-21</span></li>
                                <li><a  target="_blank">曲靖市绿能燃气运输有限公司</a><span class="time">2016-07-20</span></li>
                                <li><a  target="_blank">青海航天信息有限公司</a><span class="time">2016-07-19</span></li>
                                <li><a  target="_blank">吉林省蔬菜花卉科学研究院</a><span class="time">2016-07-17</span></li>
                                <li><a  target="_blank">青海省广播电视信息网络股份有限公司</a><span class="time">2016-07-17</span></li>
                                <li><a  target="_blank">国营长空精密机械制造公司</a><span class="time">2016-07-13</span></li>
                                <li><a  target="_blank">广东友元国土信息工程有限公司</a><span class="time">2016-07-12</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
