        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 class="fa fa-bars">奖项分类信息修改</h5>
...
<script>
    ...
    $("#saveBtn").click(function () {
        ...
        if (isEmpty('', $("input[name=name]").val(), '请输入奖项分类标题') == false) {
            return false;
        }
       
        ajaxFormBtn("{{ dashboardUrl('/vote/category/'.$info->id.'/update') }}", 'btnForm');
    });
