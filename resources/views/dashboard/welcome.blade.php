...
<head>
    ...
    <script src="{{ asset('/')}}admins/static/js/charts/Chart.js"></script>
    <script>
        $(function () {
            Canvas1();
            Canvas2();
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                ...
                                <li><a href="http://www.learun.cn/adms/index.html" target="_blank">{{ $article->title }}</a><span class="time">{{$article->addtime}}</span></li>
                                @endforeach
